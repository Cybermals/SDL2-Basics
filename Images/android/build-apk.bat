...
javac -classpath C:/android-sdk/platforms/android-28/android.jar src/org/libsdl/app/*.java src/ml/cybermals/Images/*.java -d obj
...
zipalign 4 tmp.apk SDL2Images.apk
cd ..

rem Sign the apk
echo Signing...
call apksigner sign --ks my-release-key.keystore tmp/SDL2Images.apk
echo done