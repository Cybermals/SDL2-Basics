...
javac -classpath C:/android-sdk/platforms/android-28/android.jar src/org/libsdl/app/*.java src/ml/cybermals/Input/*.java -d obj
...
zipalign 4 tmp.apk SDL2Input.apk
cd ..

rem Sign the apk
echo Signing...
call apksigner sign --ks my-release-key.keystore tmp/SDL2Input.apk
echo done