...
javac -classpath C:/android-sdk/platforms/android-28/android.jar src/org/libsdl/app/*.java src/ml/cybermals/Text/*.java -d obj
...
zipalign 4 tmp.apk SDL2Text.apk
cd ..

rem Sign the apk
echo Signing...
call apksigner sign --ks my-release-key.keystore tmp/SDL2Text.apk
echo done